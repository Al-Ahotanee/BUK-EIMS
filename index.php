...
<head>
    ...
    <style>
        ...
        ::selection { background: #C6A15B; color: #fff; }
        body { -webkit-font-smoothing: antialiased; }
        .glass-nav { background: rgba(6, 56, 91, 0.88); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); }
    </style>
</head>
                ...
                <nav className={`fixed w-full z-50 transition-all duration-300 border-b border-white/10 ${scrolled ? 'glass-nav shadow-xl py-3' : 'bg-transparent py-6'}`}>
                    <div className="container mx-auto px-6 md:px-12 flex justify-between items-center">
                        <div className="flex items-center gap-3 cursor-pointer" onClick={() => window.scrollTo(0,0)}>
                            <img src="assets/buk-logo.png" alt="Bayero University Kano crest" className="w-10 h-10 rounded-lg bg-white p-0.5 shadow-lg object-contain transform transition hover:scale-105" />
                            <div className="font-bold text-2xl tracking-tight leading-none text-white">
                                BUK <span className="text-accent block text-[10px] tracking-[0.2em] uppercase mt-1">Exam Incident System</span>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-4">
                            <button onClick={() => setView('login')} className="px-6 py-2.5 bg-accent text-white rounded-full font-bold shadow-[0_0_15px_rgba(198,161,91,0.45)] hover:bg-accent-light hover:shadow-[0_0_25px_rgba(198,161,91,0.7)] transition-all flex items-center gap-2 transform hover:-translate-y-0.5">
            ...
            const slides = [
                {
                    ...
                    subtitle: "The authoritative digital framework for tracking and resolving examination malpractice at the Bayero University Kano.",
                    ...
                    <div className="container mx-auto px-6 md:px-12 relative z-10">
                        <div className="max-w-4xl mx-auto text-center">
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 text-blue-200 text-xs font-bold uppercase tracking-wider mb-8 backdrop-blur-sm animate-slide-up">
                                ...
                                Online Exam Incident Management  Digital Framework for BUK Examination Office
                            </div>
                ...
                <div className="container mx-auto px-6 md:px-12 flex flex-col md:flex-row justify-between items-center gap-6">
                    <div className="text-center md:text-left">
                        <span className="text-2xl font-bold text-white tracking-tight">
                            BUK<span className="text-accent">EIMS</span>
                        </span>
                        <p className="text-sm mt-2 text-gray-500">Bayero University Kano &copy; {new Date().getFullYear()}</p>
                    </div>
                    ...
                    <div className="w-full max-w-md relative z-10">
                        ...
                        <form onSubmit={submit} className="bg-white p-8 rounded-2xl shadow-2xl border border-gray-100 relative">
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input className="w-full pl-11 pr-4 py-3 bg-gray-50 rounded-lg border border-gray-200 focus:border-accent focus:bg-white focus:ring-2 focus:ring-accent/20 outline-none transition" type="email" placeholder="staff@buk.edu.ng" onChange={e => setForm({...form, email: e.target.value})} required/>
                                    </div>
                                </div>
                                <div>
                            ...
                            <div className="mt-6 text-center border-t border-gray-100 pt-6">
                                <p className="text-xs text-gray-500"><i className="fas fa-shield-check text-green-500 mr-1"></i> Protected by BUK ICT Security</p>
                            </div>
                        </form>
                    </div>
                </div>
